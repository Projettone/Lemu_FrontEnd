...
class PaymentControllerApi(private val authViewModel: AuthViewModel, basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun processPaymentWithHttpInfo(amount: kotlin.Double) : ApiResponse<kotlin.Any?> {
        val localVariableConfig = processPaymentRequestConfig(amount = amount)
     ...
     */
    fun processPaymentRequestConfig(amount: kotlin.Double) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/payment-api/process-payment/{amount}".replace("{"+"amount"+"}", encodeURIComponent(amount.toString())),
