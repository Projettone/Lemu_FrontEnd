...
class WishlistControllerApi(basePath: String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun deleteWishlistRequestConfig(id: Long) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/wishlist/{id}".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = false,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getWishlistByUtenteId(utenteId: Long) : WishlistDto {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getWishlistByUtenteIdWithHttpInfo(utenteId: Long) : ApiResponse<WishlistDto?> {
     ...
     * @return RequestConfig
     */
    fun getWishlistByUtenteIdRequestConfig(utenteId: Long) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/wishlist/utente/{utenteId}".replace("{"+"utenteId"+"}", encodeURIComponent(utenteId.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = false,
            body = localVariableBody
